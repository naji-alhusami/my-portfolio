  ...
  return (
    <div className="flex flex-wrap lg:flex-nowrap h-full">
      <div className="w-full  lg:w-2/3 p-4 text-white bg-green-700">
        <img src={PersonalPhoto} alt="my-pict" className="w-60 h-64 my-4 mx-auto overflow-hidden rounded-full" />
      ...
      <div className="w-full lg:w-1/3">
        <img src={CoverPhoto} alt="my-pict" className="w-full h-screen" />
      </div>
    </div>
  );
};
